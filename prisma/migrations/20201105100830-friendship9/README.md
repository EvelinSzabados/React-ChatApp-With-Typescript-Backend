# Migration `20201105100830-friendship9`

This migration has been generated at 11/5/2020, 11:08:30 AM.
...
ALTER TABLE "public"."friendShipRequests" ADD FOREIGN KEY("senderId")REFERENCES "public"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE

ALTER TABLE "public"."friendShipRequests" ADD FOREIGN KEY("recieverId")REFERENCES "public"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE
...
migration 20201105100455-friendship8..20201105100830-friendship9
--- datamodel.dml
+++ datamodel.dml
@@ -1,7 +1,7 @@
 datasource db {
